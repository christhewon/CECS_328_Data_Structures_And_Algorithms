...
public class searches {
	public static void main(String[] args) {
		...
		System.out.println("The worst case running time for linear search in nanoseconds was: " + end/100);
		
		//Binary Search Worst Case Scenario
		start = System.nanoTime();
		binarySearch(arr, 5000);
		end = System.nanoTime() - start;
		System.out.println("The worst case running time for binary search in nanoseconds was: " + end/100);
		...
		System.out.println("Total time equals: " + end);
